...
type Validator struct {
	FieldErrors    map[string]string // Holds errors pertaining to fields
	NonFieldErrors []string          // Holds non field specific errors
}
...
// Adds a generic error, not related to any field
